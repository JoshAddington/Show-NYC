/*! angular-img-cropper 24-05-2015 */
            ...
            var d, e = e || function(a, b) {
                ...
                j = function(a) {
                    ...
                    return e(b, a), b.prototype.drawCornerBorder = function(a) {
                        ...
                        var c = 1,
                            d = 1;
                        this.horizontalNeighbour.position.x < this.position.x && (c = -1), this.verticalNeighbour.position.y < this.position.y && (d = -1), a.beginPath(), a.lineJoin = "miter", a.moveTo(this.position.x, this.position.y), a.lineTo(this.position.x + b * c, this.position.y), a.lineTo(this.position.x + b * c, this.position.y + b * d), a.lineTo(this.position.x, this.position.y + b * d), a.lineTo(this.position.x, this.position.y), a.closePath(), a.lineWidth = 2, a.strokeStyle = "rgba(255,228,0,1)", a.stroke()
                ...
                n = function() {
                    ...
                    return b.prototype.resizeCanvas = function(a, b) {
                        ...
                        var e, f = 0,
                            ...
                            n = 0,
                            o = 0;
                        a.keepAspect ? (e = d.getHorizontalNeighbour().getVerticalNeighbour(), i = e.getPosition().x, j = e.getPosition().y, b <= e.getPosition().x ? c <= e.getPosition().y ? (f = i - 100 / this.aspectRatio, h = j - 100 / this.aspectRatio * this.aspectRatio, o = this.getSide(g.instance.borrow(f, h), e.getPosition(), g.instance.borrow(b, c)), o > 0 ? (k = Math.abs(e.getPosition().y - c), l = k / this.aspectRatio, m = e.getPosition().y - k, n = e.getPosition().x - l, d.move(n, m)) : 0 > o && (l = Math.abs(e.getPosition().x - b), k = l * this.aspectRatio, m = e.getPosition().y - k, n = e.getPosition().x - l, d.move(n, m))) : (f = i - 100 / this.aspectRatio, h = j + 100 / this.aspectRatio * this.aspectRatio, o = this.getSide(g.instance.borrow(f, h), e.getPosition(), g.instance.borrow(b, c)), o > 0 ? (l = Math.abs(e.getPosition().x - b), k = l * this.aspectRatio, m = e.getPosition().y + k, n = e.getPosition().x - l, d.move(n, m)) : 0 > o && (k = Math.abs(e.getPosition().y - c), l = k / this.aspectRatio, m = e.getPosition().y + k, n = e.getPosition().x - l, d.move(n, m))) : c <= e.getPosition().y ? (f = i + 100 / this.aspectRatio, h = j - 100 / this.aspectRatio * this.aspectRatio, o = this.getSide(g.instance.borrow(f, h), e.getPosition(), g.instance.borrow(b, c)), 0 > o ? (k = Math.abs(e.getPosition().y - c), l = k / this.aspectRatio, m = e.getPosition().y - k, n = e.getPosition().x + l, d.move(n, m)) : o > 0 && (l = Math.abs(e.getPosition().x - b), k = l * this.aspectRatio, m = e.getPosition().y - k, n = e.getPosition().x + l, d.move(n, m))) : (f = i + 100 / this.aspectRatio, h = j + 100 / this.aspectRatio * this.aspectRatio, o = this.getSide(g.instance.borrow(f, h), e.getPosition(), g.instance.borrow(b, c)), 0 > o ? (l = Math.abs(e.getPosition().x - b), k = l * this.aspectRatio, m = e.getPosition().y + k, n = e.getPosition().x + l, d.move(n, m)) : o > 0 && (k = Math.abs(e.getPosition().y - c), l = k / this.aspectRatio, m = e.getPosition().y + k, n = e.getPosition().x + l, d.move(n, m)))) : d.move(b, c), this.center.recalculatePosition(this.getBounds())
                        ...
                        if (a.preventDefault(), a.touches.length >= 1)
                            for (var b = 0; b < a.touches.length; b++) {
                                var c = a.touches[b],
                                    ...
                                    e = new m(d.x, d.y, c.identifier);
                                g.instance.returnPoint(d), this.move(e, a)
                            }
                        this.draw(this.ctx)
                        ...
                        this.isMouseDown && this.handleMove(b), a.cropAreaBounds && this.imageSet && (a.cropAreaBounds = this.getCropBounds(), a.$apply())
